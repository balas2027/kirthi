        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="user_page.php">Map</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="col-12">
                <div class="alert alert-info">
                    Welcome to your SafeRoute dashboard. Explore the map below to check crime levels and navigate safely.
                </div>
                
                <!-- Map Card -->
                <div class="card mt-4">
                    <div class="card-header">
                        <h5 class="card-title">Chennai Crime Map</h5>
                    </div>
