    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-black/40 backdrop-blur-lg border-b border-gray-800/30">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-8">
                ...
                <div class="flex items-center space-x-4">
                    <a href="#" class="text-gray-300 hover:text-green-400 transition font-medium">Sign In</a>
                    <a href="#" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full transition text-sm font-semibold">Login</a>
                </div>
            </div>
        </div>
    </nav>
